...
ping "start smoke-1   " 202 "$KEY" '{"pipeline":"'$SLUG'","status":"start","run_id":"smoke-1"}'
ping "close smoke-1   " 202 "$KEY" '{"pipeline":"'$SLUG'","status":"success","run_id":"smoke-1"}'
ping "replay close    " 202 "$KEY" '{"pipeline":"'$SLUG'","status":"success","run_id":"smoke-1"}'
ping "no-start close  " 202 "$KEY" '{"pipeline":"'$SLUG'","status":"success","run_id":"smoke-2"}'
...
ping "fail smoke-3    " 202 "$KEY" '{"pipeline":"'$SLUG'","status":"fail","run_id":"smoke-3","exit_code":1,"message":"timeout"}'